...
GameLose::GameLose(float x, float y) : selectedItemIndex(0) {
...
void GameLose::draw(sf::RenderWindow& window) {
    window.draw(title);
...
int GameLose::getSelectedItemIndex() const {
